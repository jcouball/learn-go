...
Channels](ch12.md#using-for-range-and-channels).
...
Assertions and Type Switches](ch07.md#type-assertions-and-type-switches).
...
elegantly. `defer` is described in [Chapter 5: Functions > defer](ch05.md#defer). Using
