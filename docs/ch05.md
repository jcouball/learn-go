...
These *inner functions* are *anonymous* because they don’t have a name.
...
2. launching goroutines (covered in [Chapter 12: Concurrency in Go > Goroutines](ch12.md#goroutines))
